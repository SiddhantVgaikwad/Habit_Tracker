...
const AddHabit = () => {
    ...
    return(
        ...
        // main container
        <div className="w-full lg:w-4/5 h-60 rounded border-4 border-blue-500 bg-blue-100   
                        justify-self-end flex flex-col ">
            
            {/* heading of section */}
            <h1 className="bg-blue-500 text-white text-lg font-bold text-center border-2 border-blue-500 p-2 font-sans tracking-widest ">
                ADD YOUR HABIT 
            </h1>

            {/* form container to get user's data */}
            <div className="w-4/5 self-center mt-7 ">
