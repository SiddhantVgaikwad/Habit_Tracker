...
const WeekStatus = ({habitIndex,handleCloseClick,showStatus,weekDays}) => {
    ...
    return(
        // container
        <div className="w-full p-1 h-full border-b-2 md:border-none">
            
            {/* button to hide the section */}
            {/* hidden on smaller screen */}
            <button className="hidden md:block float-right bg-red-500 text-white px-[5px] rounded-md"
            ...
            <div className="w-full h-fill mt-[5%] bg-fixed overflow-scroll">
                ...
                {/* heading */}
                <h1 className="w-full text-center text-lg font-semibold border-b-4 border-blue-950">Your Weekly Progress:</h1>
