            ...
            <nav className="w-full p-1">
                ...
                <NavLink to="/">
                    ...
                    <button className="bg-green-600 hover:bg-green-400 
                                    float-left p-2 rounded text-white">
                       Add New Habit
                    </button>
                    <img src={require('../Assets/goal.png')} alt="logo" className="w-12 mt-1 float-right"/>
                </NavLink>
                ...
                <div className="hidden md:block w-full">
                    ...
                    { !showStatus?
                        <h1 className="text-center text-2xl font-semibold">
                            ...
                            <h1 className="font-bold  text-4xl mb-2">Stay Empowered by Your Progress</h1><br/>
                            {habits.length !== 0 ?
