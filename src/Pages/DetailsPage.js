...
const DetailsPage = () => {
    ...
    return(
        ...
        <div className="w-full h-full bg-fixed overflow-auto flex justify-center items-center">
            ...
            <div className="w-[100%] h-[100%] rounded shadow-md flex flex-col justify-between 
                            p-2 items-center">
                
                {/* to show a header on page */}
                <div className="w-full h-12 rounded shadow-md bg-indigo-400 p-1 px-2 
                ...
                <div className="w-full h-[90%] rounded shadow-sm flex bg-purple-100 bg-fixed">
